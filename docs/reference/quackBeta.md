...
This function uses the expectation maximization of both the beta and
beta-uniform mixture models for model selection. Here we can run up to
32 mixture models.
...
#> Calculating likelihood of each mixture with a beta distibution.
#> Calculating likelihood of each mixture with a beta + unform distibution.
```
