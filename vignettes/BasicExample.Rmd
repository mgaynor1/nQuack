...
Here we provide an example to show you how to apply this method on real samples. All associated data files can be found in "inst/extdata/" folder in our [github repository](https://github.com/mgaynor1/nQuack). 
