...
#'
#' @description This function is used to simulate the frequency of
...
#' @param tau Overdispersion parameter. Defaults to 0.01.
#' @param error Sequencing error rate. Defaults to 0.001.
